...
fn create_simple_png_bytes() -> Vec<u8> {
    ...
    vec![
        ...
        0x08, 0x02, 0x00, 0x00, 0x00, 0x44, 0x44, 0x4f,
        0x65, 0x41, 0x49, 0x44, 0x41, 0x54, 0x08, 0xd7,
        0x63, 0xf8, 0xcf, 0xc0, 0x00, 0x00, 0x00, 0x03,
        0x00, 0x01, 0xe5, 0x21, 0xbc, 0x33, 0x49, 0x45,
    ...
    c.bench_function("encode_small_image_512x512", |b| {
        b.iter_batched(
            ...
            |test_png| {
                ...
                let _ = cafe::encode(black_box(&test_png), black_box(output_path), black_box(&opts));
            },
