...
**Last updated:** September 3, 2026 | **Project version:** v1.8.0 | **ARM NEON SIMD Phase (Sep 1/2026) + Compression-Focused Audit (Sep 2/2026) + Streaming Encoder (Sep 3/2026) + CLI ICC/XMP flags (Sep 3/2026, v1.6.1) + Real compression_stats + cafe-decode export flags (Sep 3/2026, v1.6.2) + Nightly fuzz CI workflow (Sep 3/2026, v1.6.3) + k-means palette quantization (Sep 3/2026, v1.7) + Inverse tone-mapping on encode (Sep 3/2026, v1.8):**
